      ...
      <section id="resume">
         ...
         <div className="row skill">
            ...
            <div className="nine columns main-col">
               ...
               <p>Below are a list of technical skills I have aquired while living in "The Land of the Morning Calm." Everything is still a work in progress, but in the future, I plan to incorporate more programming languages (hello Python and Swift!), improve upon frameworks I have worked with somewhat (Meteor.js, Express.js), and up my Adobe Creative Suite Skills.
               </p>
